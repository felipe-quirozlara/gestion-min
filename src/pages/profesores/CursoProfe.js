                ...
                <div className="container-fluid mx-4 mt-3">
                    <div className="d-flex align-items-start">
                        <div className="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <button className="nav-link" id="v-pills-assis-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-assis" type="button" role="tab" aria-controls="v-pills-assis"
                                aria-selected="false">Asistencia</button>
                        </div>
                        <div className="tab-content" id="v-pills-tabContent" style={{ width: "100vw" }}>
                            ...
                            <div className="tab-pane fade" id="v-pills-assis" role="tabpanel"
                                aria-labelledby="v-pills-assis" tabindex="0">
                                <div className='container'>
                                    <h2>Asistencia</h2>
                                    <div className='container border rounded'>
                                        <div class="d-flex flex-row justify-content-around my-4">
                                            <Link to={"/profe/historial-asistencia"}>
                                                <button className='btn btn-primary' >Ver historial</button>
                                            </Link>
                                            <Link to={"/profe/asistencia"}>
                                                <button className='btn btn-info'>Asistencia hoy</button>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
